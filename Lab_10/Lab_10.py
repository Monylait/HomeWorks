...
def Destroy_Zakha_Chat():
    driver = Chrome()
    string="https://vk.com/dev/messages.send?params[user_id]=323367571&params[random_id]="+str(random.randint(0,100000000))+"&params[peer_id]=327099867&params[message]=Утро доброе&params[dont_parse_links]=0&params[disable_mentions]=0&params[intent]=default&params[v]=5.124"
    ...
    for z in range(1,50000):
        ...
        for i in flats:
            ...
            button=button[0]
            button.click()
        string="https://vk.com/dev/messages.send?params[user_id]=323367571&params[random_id]="+str(random.randint(0,100000000))+"&params[peer_id]=327099867&params[message]=Утро доброе "+str(z)+"&params[dont_parse_links]=0&params[disable_mentions]=0&params[intent]=default&params[v]=5.124"
        time.sleep(7)
